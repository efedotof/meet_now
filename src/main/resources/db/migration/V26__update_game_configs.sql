-- Migration: V26__update_game_configs.sql
-- Обновление данных в таблице game_configs

-- Удаляем старые записи
DELETE FROM game_configs;

-- Вставляем обновленные записи
...
COMMENT ON TABLE game_configs IS 'Конфигурации игр с обновленными ссылками на изображения';
COMMENT ON COLUMN game_configs.thumbnail_url IS 'URL миниатюры игры из нового хранилища';