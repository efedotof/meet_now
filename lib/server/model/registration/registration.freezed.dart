...
mixin _$Registration {
 ...
 String get username; String get email; String get firstname; String get subname; String get descriptio; String get avatar; String get city; int get age; List<String> get purposes; List<String> get interests; bool get isSearchable; String get password;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Registration&&(identical(other.username, username) || other.username == username)&&(identical(other.email, email) || other.email == email)&&(identical(other.firstname, firstname) || other.firstname == firstname)&&(identical(other.subname, subname) || other.subname == subname)&&(identical(other.descriptio, descriptio) || other.descriptio == descriptio)&&(identical(other.avatar, avatar) || other.avatar == avatar)&&(identical(other.city, city) || other.city == city)&&(identical(other.age, age) || other.age == age)&&const DeepCollectionEquality().equals(other.purposes, purposes)&&const DeepCollectionEquality().equals(other.interests, interests)&&(identical(other.isSearchable, isSearchable) || other.isSearchable == isSearchable)&&(identical(other.password, password) || other.password == password));
}


@override
int get hashCode => Object.hash(runtimeType,username,email,firstname,subname,descriptio,avatar,city,age,const DeepCollectionEquality().hash(purposes),const DeepCollectionEquality().hash(interests),isSearchable,password);

@override
String toString() {
  return 'Registration(username: $username, email: $email, firstname: $firstname, subname: $subname, descriptio: $descriptio, avatar: $avatar, city: $city, age: $age, purposes: $purposes, interests: $interests, isSearchable: $isSearchable, password: $password)';
}
...
@useResult
$Res call({
 String username, String email, String firstname, String subname, String descriptio, String avatar, String city, int age, List<String> purposes, List<String> interests, bool isSearchable, String password
});
...
/// Create a copy of Registration
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? username = null,Object? email = null,Object? firstname = null,Object? subname = null,Object? descriptio = null,Object? avatar = null,Object? city = null,Object? age = null,Object? purposes = null,Object? interests = null,Object? isSearchable = null,Object? password = null,}) {
...
as String,descriptio: null == descriptio ? _self.descriptio : descriptio // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String username,  String email,  String firstname,  String subname,  String descriptio,  String avatar,  String city,  int age,  List<String> purposes,  List<String> interests,  bool isSearchable,  String password)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Registration() when $default != null:
return $default(_that.username,_that.email,_that.firstname,_that.subname,_that.descriptio,_that.avatar,_that.city,_that.age,_that.purposes,_that.interests,_that.isSearchable,_that.password);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String username,  String email,  String firstname,  String subname,  String descriptio,  String avatar,  String city,  int age,  List<String> purposes,  List<String> interests,  bool isSearchable,  String password)  $default,) {final _that = this;
switch (_that) {
case _Registration():
return $default(_that.username,_that.email,_that.firstname,_that.subname,_that.descriptio,_that.avatar,_that.city,_that.age,_that.purposes,_that.interests,_that.isSearchable,_that.password);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String username,  String email,  String firstname,  String subname,  String descriptio,  String avatar,  String city,  int age,  List<String> purposes,  List<String> interests,  bool isSearchable,  String password)?  $default,) {final _that = this;
switch (_that) {
case _Registration() when $default != null:
return $default(_that.username,_that.email,_that.firstname,_that.subname,_that.descriptio,_that.avatar,_that.city,_that.age,_that.purposes,_that.interests,_that.isSearchable,_that.password);case _:
  return null;
...
class _Registration implements Registration {
   _Registration({required this.username, required this.email, required this.firstname, required this.subname, required this.descriptio, required this.avatar, required this.city, required this.age, required final  List<String> purposes, required final  List<String> interests, required this.isSearchable, required this.password}): _purposes = purposes,_interests = interests;
...
@override final  String descriptio;
...
@override
int get hashCode => Object.hash(runtimeType,username,email,firstname,subname,descriptio,avatar,city,age,const DeepCollectionEquality().hash(_purposes),const DeepCollectionEquality().hash(_interests),isSearchable,password);
...
/// Create a copy of Registration
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? username = null,Object? email = null,Object? firstname = null,Object? subname = null,Object? descriptio = null,Object? avatar = null,Object? city = null,Object? age = null,Object? purposes = null,Object? interests = null,Object? isSearchable = null,Object? password = null,}) {
