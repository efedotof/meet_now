...
class SyncTimerState with _$SyncTimerState {
  ...
  const factory SyncTimerState.timeAdded({
    required int additionalMinutes,
  }) = _TimeAdded;
  ...
  int get remainingTime => when(
    ...
    finished: () => 0,
    addTimeProposed: (remainingTime, formattedTime, additionalMinutes, fromUserId) => remainingTime,
    waitingForResponse: (remainingTime, formattedTime, additionalMinutes) => remainingTime,
  ...
  String get formattedTime => when(
    ...
    finished: () => '00:00',
    addTimeProposed: (remainingTime, formattedTime, additionalMinutes, fromUserId) => formattedTime,
    waitingForResponse: (remainingTime, formattedTime, additionalMinutes) => formattedTime,
