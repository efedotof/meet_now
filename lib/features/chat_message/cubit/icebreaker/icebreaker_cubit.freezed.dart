...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IcebreakerState);
}
...
/// @nodoc
class $IcebreakerStateCopyWith<$Res>  {
$IcebreakerStateCopyWith(IcebreakerState _, $Res Function(IcebreakerState) __);
}


/// Adds pattern-matching-related methods to [IcebreakerState].
extension IcebreakerStatePatterns on IcebreakerState {
...
class _Initial implements IcebreakerState {
  const _Initial();
...
@override
String toString() {
  return 'IcebreakerState.initial()';
}
