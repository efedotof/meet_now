...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SettingProfileState);
}
...
/// @nodoc
class $SettingProfileStateCopyWith<$Res>  {
$SettingProfileStateCopyWith(SettingProfileState _, $Res Function(SettingProfileState) __);
}
...
class _Initial implements SettingProfileState {
  const _Initial();
...
@override
String toString() {
  return 'SettingProfileState.initial()';
}
