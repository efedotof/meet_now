...
class _SearchScreenState extends State<SearchScreen> {
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            border: OutlineInputBorder(
                                              ...
                                              borderSide: BorderSide(
                                                color: colors.outline.withAlpha(
                                                  50,
                                                ),
                                              ),
                                            ),
  ...
  void _handleNavigation(BuildContext context, SearchState state) {
        ...
        if (mounted) {
          ...
          if (shouldOpenInModal) {
            ...
            showDialog(
              ...
              builder:
                  (context) => _buildChatModal(context, state.matchedChat!),
            ).then((_) {
  ...
  Widget _buildChatModal(BuildContext context, TemporaryChat chat) {
