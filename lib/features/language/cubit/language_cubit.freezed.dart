...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function( Locale currentLocale,  List<Locale> supportedLocales)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loaded() when loaded != null:
return loaded(_that.currentLocale,_that.supportedLocales);case _Error() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function( Locale currentLocale,  List<Locale> supportedLocales)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case _Initial():
return initial();case _Loaded():
return loaded(_that.currentLocale,_that.supportedLocales);case _Error():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function( Locale currentLocale,  List<Locale> supportedLocales)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case _Initial() when initial != null:
return initial();case _Loaded() when loaded != null:
return loaded(_that.currentLocale,_that.supportedLocales);case _Error() when error != null:
...
class _Loaded implements LanguageState {
  const _Loaded({required this.currentLocale, required final  List<Locale> supportedLocales}): _supportedLocales = supportedLocales;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Loaded&&(identical(other.currentLocale, currentLocale) || other.currentLocale == currentLocale)&&const DeepCollectionEquality().equals(other._supportedLocales, _supportedLocales));
}
...
@override
String toString() {
  return 'LanguageState.loaded(currentLocale: $currentLocale, supportedLocales: $supportedLocales)';
}
...
/// Create a copy of LanguageState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? currentLocale = null,Object? supportedLocales = null,}) {
...
class _Error implements LanguageState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $LanguageStateCopyWith<$Res> {
